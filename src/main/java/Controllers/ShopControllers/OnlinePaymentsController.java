    ...
    private void buttonListeners() {
        ...
        goofflinepayments.setOnMouseClicked(new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent event) {
                try {
                    panel.getChildren().setAll(Collections.singleton(FXMLLoader.load(Objects.requireNonNull(getClass().getClassLoader().getResource("shopFiles/showpriceexitcash.fxml")))));
                } catch (IOException e) {
                    e.printStackTrace();
                }
