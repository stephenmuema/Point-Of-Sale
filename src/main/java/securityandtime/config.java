...
public interface config {//host,user,password,des,port
    ...
    String fileSavePath = "C:"+File.separator+"NANOTECHSOFTWARES"+File.separator+"nanotechPOS"+File.separator+"";
    ...
    String NANOTECHSOFTWARES_SETTINGS = "C:"+File.separator+"NANOTECHSOFTWARES"+File.separator+"settings"+File.separator+"";
